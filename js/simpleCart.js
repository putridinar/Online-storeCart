        ...
        generateSimpleCart = function (space) {
            ...
            cartColumnViews = {
                ...
                totalberat: function (item, column) {
                    return "<ion-text class='total-berat' data-berat='" + item.get(column.attr) + "'>Berat" + formatBerat(item.get(column.attr)) + "</iin-text>";
                },
            ...
            simpleCart.ready(function () {
                simpleCart.bindOutlets({
                    ...
                    grandTotal: function () {
                        return ["<ion-text id='totalpembayaran' class='totalpembayaran' data-total='" + simpleCart.grandTotal() + "'>" + simpleCart.toCurrency(simpleCart.grandTotal()) + "</ion-text"];
                    },
                });
